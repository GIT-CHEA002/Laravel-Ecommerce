...
@endphp
<footer class="border-t border-indigo-700 dark:border-indigo-500">
  <div class=" py-8 default-padding border-b border-indigo-700 dark:border-indigo-500">
    {{-- footer nav --}}
  ...
  <x-footer.client-footer.copy-right />
</footer>